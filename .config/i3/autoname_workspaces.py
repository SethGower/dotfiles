...
#
# Installation:
# * Download this script and place it in ~/.config/i3/bin
# * Add "exec_always ~/.config/i3/bin/autoname-workspaces.py &" to your i3 config
...
WINDOW_ICONS = {
    'atom': fa.icons['code'],
    'boost': fa.icons['paper-plane'],
    'boostnote': fa.icons['paper-plane'],
    'cura': fa.icons['cube'],
